...
def get_positive_dict(basedir, sequences, output_dir, d_thresh, t_thresh):
    ...
    for sequence in sequences:
        print(sequence)
        _, scan_positions = load_poses_from_txt(basedir + 'sequences/' + sequence + '/poses.txt')
        scan_timestamps = load_timestamps(basedir + 'sequences/' + sequence + '/times.txt')
...
if __name__ == "__main__":
    ...
    output_dir = os.path.join(os.path.dirname(__file__), '../../config/kitti_tuples/')
