...
# Contrastive
trainer_arg.add_argument('--train_loss_function', type=str, default='quadruplet')#quadruplet, triplet
...
trainer_arg.add_argument('--negatives_per_query', type=int, default=1)#2-18
...
# Point Contrastive
trainer_arg.add_argument('--point_loss_function', type=str, default='contrastive')#infonce, contrastive
...
opt_arg.add_argument('--scheduler', type=str, default='lambda') #cosine#multistep

# Dataset specific configurations
data_arg = add_argument_group('Data')
data_arg.add_argument('--dataset', type=str, default='KittiPointSparseTupleDataset')#KittiPointSparseTupleDataset#MulRanPointSparseTupleDataset
...
data_arg.add_argument("--gp_rem", type=str2bool, default=True, help="Remove ground plane.")
data_arg.add_argument("--pnv_preprocessing", type=str2bool, default=False, help="Preprocessing in dataloader for PNV.")

data_arg.add_argument('--kitti_dir', type=str, default='/mnt/088A6CBB8A6CA742/Datasets/Kitti/dataset/', help="Path to the KITTI odometry dataset")
...
data_arg.add_argument('--mulran_dir', type=str, default='/mnt/088A6CBB8A6CA742/Datasets/MulRan/', help="Path to the MulRan dataset")
