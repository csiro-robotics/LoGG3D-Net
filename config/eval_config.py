...
eval_arg.add_argument('--mulran_eval_seq', type=str, default='Riverside/Riverside_02')
eval_arg.add_argument('--checkpoint_name', type=str, default='/kitti_10cm_loo/2021-09-14_20-28-22_3n24h_Kitti_v10_q29_10s8_263169')
...
eval_arg.add_argument("--not_revisit_criteria", default=20, type=float, help="in meters")
...
data_arg.add_argument('--eval_dataset', type=str, default='KittiDataset')#KittiDataset#MulRanDataset
...
data_arg.add_argument('--eval_feature_distance', type=str, default='cosine')#cosine#euclidean
